      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 28 }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: 13, color: "var(--text-secondary)" }}>Review and approve subscription payments</p>
          </div>
          <button
            ...
            <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 16, padding: "28px 24px", maxWidth: 440, width: "100%" }}>
              ...
              <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
                <button
                  ...
                  style={{ flex: 1, padding: "11px 0", borderRadius: 10, border: "1px solid var(--border)", background: "none", cursor: "pointer", fontSize: 14, color: "var(--text-secondary)" }}
                >
                  Cancel
                </button>
                <button
                  ...
                  style={{ flex: 1, padding: "11px 0", borderRadius: 10, border: "none", background: "var(--destructive, #dc2626)", color: "#fff", cursor: "pointer", fontSize: 14, fontWeight: 700 }}
                >
